...
ESCUDOS_TIMES = {
    ...
    "Remo": (
        "https://icon2.cleanpng.com/20180411/wte/av-logo-club-do-remo-5acc1567d0ee93.4074213015233119758558.png"
    ),
    "Chapecoense": (
...
CALENDARIO_RODADAS = {
    27: [
        ("Coritiba", "Athletico-PR", "Sexta, 11/09/2026 - 21:00"),
        ("Atlético-MG", "Fluminense", "Sábado, 12/09/2026 - 16:00"),
        ("Grêmio", "Vasco", "Sábado, 12/09/2026 - 16:00"),
        ("Chapecoense", "Internacional", "Sábado, 12/09/2026 - 17:00"),
        ("Palmeiras", "São Paulo", "Sábado, 12/09/2026 - 18:30"),
        ("Botafogo", "Red Bull Bragantino", "Sábado, 12/09/2026 - 20:30"),
        ("Santos", "Cruzeiro", "Sábado, 12/09/2026 - 21:00"),
        ("Mirassol", "Vitória", "Domingo, 13/09/2026 - 16:00"),
        ("Flamengo", "Corinthians", "Domingo, 13/09/2026 - 17:30"),
        ("Bahia", "Remo", "Segunda, 14/09/2026 - 20:00"),
    ],
    28: [
        ("Atlético-MG", "Chapecoense", "Sábado, 19/09/2026 - 16:00"),
        ("Mirassol", "Botafogo", "Sábado, 19/09/2026 - 17:00"),
        ("Remo", "Santos", "Sábado, 19/09/2026 - 18:30"),
        ("Vasco", "Coritiba", "Sábado, 19/09/2026 - 20:30"),
        ("São Paulo", "Internacional", "Sábado, 19/09/2026 - 21:00"),
        ("Grêmio", "Palmeiras", "Domingo, 20/09/2026 - 11:00"),
        ("Vitória", "Cruzeiro", "Domingo, 20/09/2026 - 16:00"),
        ("Corinthians", "Fluminense", "Domingo, 20/09/2026 - 16:00"),
        ("Red Bull Bragantino", "Flamengo", "Domingo, 20/09/2026 - 18:30"),
        ("Athletico-PR", "Bahia", "Segunda, 21/09/2026 - 20:00"),
    ],
    29: [
        ("Fluminense", "Grêmio", "Sábado, 26/09/2026 - 16:00"),
        ("Palmeiras", "Mirassol", "Sábado, 26/09/2026 - 18:30"),
        ("Cruzeiro", "Vasco", "Sábado, 26/09/2026 - 21:00"),
        ("Bahia", "Atlético-MG", "Domingo, 27/09/2026 - 16:00"),
        ("Flamengo", "São Paulo", "Domingo, 27/09/2026 - 16:00"),
        ("Internacional", "Corinthians", "Domingo, 27/09/2026 - 18:30"),
        ("Botafogo", "Remo", "Domingo, 27/09/2026 - 18:30"),
        ("Santos", "Athletico-PR", "Segunda, 28/09/2026 - 20:00"),
        ("Coritiba", "Red Bull Bragantino", "Segunda, 28/09/2026 - 20:00"),
        ("Chapecoense", "Vitória", "Segunda, 28/09/2026 - 21:00"),
    ],
    30: [
        ("Atlético-MG", "Palmeiras", "Sábado, 03/10/2026 - 16:00"),
        ("Vasco", "Flamengo", "Sábado, 03/10/2026 - 18:30"),
        ("Grêmio", "Santos", "Sábado, 03/10/2026 - 21:00"),
        ("São Paulo", "Bahia", "Domingo, 04/10/2026 - 16:00"),
        ("Corinthians", "Botafogo", "Domingo, 04/10/2026 - 16:00"),
        ("Red Bull Bragantino", "Internacional", "Domingo, 04/10/2026 - 18:30"),
        ("Mirassol", "Fluminense", "Domingo, 04/10/2026 - 18:30"),
        ("Athletico-PR", "Chapecoense", "Segunda, 05/10/2026 - 20:00"),
        ("Remo", "Coritiba", "Segunda, 05/10/2026 - 20:00"),
        ("Vitória", "Cruzeiro", "Segunda, 05/10/2026 - 21:00"),
    ],
    31: [
        ("Flamengo", "Grêmio", "Sábado, 10/10/2026 - 16:00"),
        ("Palmeiras", "Vasco", "Sábado, 10/10/2026 - 18:30"),
        ("Fluminense", "São Paulo", "Sábado, 10/10/2026 - 21:00"),
        ("Botafogo", "Atlético-MG", "Domingo, 11/10/2026 - 16:00"),
        ("Bahia", "Corinthians", "Domingo, 11/10/2026 - 16:00"),
        ("Santos", "Mirassol", "Domingo, 11/10/2026 - 18:30"),
        ("Internacional", "Remo", "Domingo, 11/10/2026 - 18:30"),
        ("Coritiba", "Vitória", "Segunda, 12/10/2026 - 20:00"),
        ("Chapecoense", "Red Bull Bragantino", "Segunda, 12/10/2026 - 20:00"),
        ("Cruzeiro", "Athletico-PR", "Segunda, 12/10/2026 - 21:00"),
    ],
    32: [
        ("Atlético-MG", "Santos", "Sábado, 17/10/2026 - 16:00"),
        ("Grêmio", "Bahia", "Sábado, 17/10/2026 - 18:30"),
        ("São Paulo", "Coritiba", "Sábado, 17/10/2026 - 21:00"),
        ("Vasco", "Fluminense", "Domingo, 18/10/2026 - 16:00"),
        ("Corinthians", "Palmeiras", "Domingo, 18/10/2026 - 16:00"),
        ("Red Bull Bragantino", "Botafogo", "Domingo, 18/10/2026 - 18:30"),
        ("Mirassol", "Flamengo", "Domingo, 18/10/2026 - 18:30"),
        ("Remo", "Chapecoense", "Segunda, 19/10/2026 - 20:00"),
        ("Vitória", "Internacional", "Segunda, 19/10/2026 - 20:00"),
        ("Athletico-PR", "Cruzeiro", "Segunda, 19/10/2026 - 21:00"),
    ],
    33: [
        ("Flamengo", "Atlético-MG", "Sábado, 24/10/2026 - 16:00"),
        ("Palmeiras", "Red Bull Bragantino", "Sábado, 24/10/2026 - 18:30"),
        ("Fluminense", "Remo", "Sábado, 24/10/2026 - 21:00"),
        ("Botafogo", "São Paulo", "Domingo, 25/10/2026 - 16:00"),
        ("Bahia", "Vasco", "Domingo, 25/10/2026 - 16:00"),
        ("Santos", "Corinthians", "Domingo, 25/10/2026 - 18:30"),
        ("Coritiba", "Grêmio", "Domingo, 25/10/2026 - 18:30"),
        ("Internacional", "Athletico-PR", "Segunda, 26/10/2026 - 20:00"),
        ("Chapecoense", "Mirassol", "Segunda, 26/10/2026 - 20:00"),
        ("Cruzeiro", "Vitória", "Segunda, 26/10/2026 - 21:00"),
    ],
    34: [
        ("Atlético-MG", "Coritiba", "Sábado, 31/10/2026 - 16:00"),
        ("Grêmio", "Botafogo", "Sábado, 31/10/2026 - 18:30"),
        ("São Paulo", "Santos", "Sábado, 31/10/2026 - 21:00"),
        ("Vasco", "Internacional", "Domingo, 01/11/2026 - 16:00"),
        ("Corinthians", "Flamengo", "Domingo, 01/11/2026 - 16:00"),
        ("Red Bull Bragantino", "Fluminense", "Domingo, 01/11/2026 - 18:30"),
        ("Mirassol", "Bahia", "Domingo, 01/11/2026 - 18:30"),
        ("Remo", "Palmeiras", "Segunda, 02/11/2026 - 20:00"),
        ("Vitória", "Chapecoense", "Segunda, 02/11/2026 - 20:00"),
        ("Athletico-PR", "Remo", "Segunda, 02/11/2026 - 21:00"),
    ],
    35: [
        ("Flamengo", "Palmeiras", "Sábado, 07/11/2026 - 16:00"),
        ("Fluminense", "Athletico-PR", "Sábado, 07/11/2026 - 18:30"),
        ("Botafogo", "Vasco", "Sábado, 07/11/2026 - 21:00"),
        ("Bahia", "Red Bull Bragantino", "Domingo, 08/11/2026 - 16:00"),
        ("Santos", "Vitória", "Domingo, 08/11/2026 - 16:00"),
        ("Coritiba", "Corinthians", "Domingo, 08/11/2026 - 18:30"),
        ("Internacional", "Atlético-MG", "Domingo, 08/11/2026 - 18:30"),
        ("Chapecoense", "Grêmio", "Segunda, 09/11/2026 - 20:00"),
        ("Remo", "Mirassol", "Segunda, 09/11/2026 - 20:00"),
        ("Cruzeiro", "São Paulo", "Segunda, 09/11/2026 - 21:00"),
    ],
    36: [
        ("Atlético-MG", "Cruzeiro", "Sábado, 21/11/2026 - 16:00"),
        ("Palmeiras", "Bahia", "Sábado, 21/11/2026 - 18:30"),
        ("Grêmio", "Internacional", "Sábado, 21/11/2026 - 21:00"),
        ("São Paulo", "Remo", "Domingo, 22/11/2026 - 16:00"),
        ("Vasco", "Santos", "Domingo, 22/11/2026 - 16:00"),
        ("Corinthians", "Chapecoense", "Domingo, 22/11/2026 - 18:30"),
        ("Red Bull Bragantino", "Mirassol", "Domingo, 22/11/2026 - 18:30"),
        ("Athletico-PR", "Flamengo", "Segunda, 23/11/2026 - 20:00"),
        ("Vitória", "Botafogo", "Segunda, 23/11/2026 - 20:00"),
        ("Coritiba", "Fluminense", "Segunda, 23/11/2026 - 21:00"),
    ],
    37: [
        ("Flamengo", "Cruzeiro", "Quarta, 25/11/2026 - 20:00"),
        ("Fluminense", "Bahia", "Quarta, 25/11/2026 - 20:00"),
        ("Botafogo", "Palmeiras", "Quarta, 25/11/2026 - 21:30"),
        ("Grêmio", "Atlético-MG", "Quarta, 25/11/2026 - 21:30"),
        ("Santos", "Chapecoense", "Quinta, 26/11/2026 - 19:00"),
        ("Corinthians", "São Paulo", "Quinta, 26/11/2026 - 20:00"),
        ("Vasco", "Vitória", "Quinta, 26/11/2026 - 20:00"),
        ("Mirassol", "Athletico-PR", "Quinta, 26/11/2026 - 21:30"),
        ("Remo", "Red Bull Bragantino", "Quinta, 26/11/2026 - 21:30"),
        ("Internacional", "Coritiba", "Quinta, 26/11/2026 - 21:30"),
    ],
    38: [
        ("Atlético-MG", "Mirassol", "Domingo, 29/11/2026 - 16:00"),
        ("Palmeiras", "Fluminense", "Domingo, 29/11/2026 - 16:00"),
        ("Bahia", "Santos", "Domingo, 29/11/2026 - 16:00"),
        ("São Paulo", "Vasco", "Domingo, 29/11/2026 - 16:00"),
        ("Cruzeiro", "Corinthians", "Domingo, 29/11/2026 - 16:00"),
        ("Red Bull Bragantino", "Grêmio", "Domingo, 29/11/2026 - 16:00"),
        ("Athletico-PR", "Botafogo", "Domingo, 29/11/2026 - 16:00"),
        ("Vitória", "Flamengo", "Domingo, 29/11/2026 - 16:00"),
        ("Coritiba", "Remo", "Domingo, 29/11/2026 - 16:00"),
        ("Chapecoense", "Internacional", "Domingo, 29/11/2026 - 16:00"),
    ],
}
...
with tab_simulador:
  ...
  for idx, (mandante, visitante, data_hora_str) in enumerate(
    ...
    try:
      # Exemplo de string: "Sábado, 12/09/2026 - 18:30" -> limpa o dia da semana
      partes_data = data_hora_str.split(", ")[1]
      dt_jogo = datetime.strptime(partes_data, "%d/%m/%Y - %H:%M")
